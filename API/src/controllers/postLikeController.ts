...
export class PostLikeController {
    static async createPostLike (req: AuthRequest, res: Response, next: NextFunction) : Promise<void> {
        try {
    ...
    static async getAllPostLike (req: AuthRequest, res: Response, next: NextFunction) : Promise<void> {
        try {
    ...
    static async getOnePostLike (req: AuthRequest, res: Response, next: NextFunction) : Promise<void> {
        try {
            const { userId, actif } = req.auth || {};
            if (actif == '1') {
                const postLikeModel: PostLikeModel = new PostLikeModel();
    ...
    static async deletePostLike (req: AuthRequest, res: Response, next: NextFunction) : Promise<void> {
        try {
