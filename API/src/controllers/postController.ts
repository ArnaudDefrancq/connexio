...
export class PostController {
    ...
    static async getAllPostWithProfil (req: AuthRequest, res: Response, next: NextFunction) : Promise<void> {
        try {
    ...
    static async getOnePostWithProfil (req: AuthRequest, res: Response, next: NextFunction) : Promise<void> {
        try {
